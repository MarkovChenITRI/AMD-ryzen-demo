...
AMD Ryzen APU內部雖然已經搭載了完整的internal GPU(=iGPU)及NPU，但是這些處理器僅支援"推論"相關的流程，針對"訓練"方面的工作則需依靠其內建的CPU。或者，您也可以透過外部擴充槽圖形卡(如：[Radeon](https://www.amd.com/en/products/graphics/desktops/radeon.html))來增強
