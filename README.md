...
2. 如果要將模型部署到NPU，需要先透過Quark將ONNX進行量化編譯。可以利用`onnx_quantizer.py`將指定的onnx檔
   > [參數配置](https://quark.docs.amd.com/latest/onnx/appendix_full_quant_config_features.html)
   > ```bash
